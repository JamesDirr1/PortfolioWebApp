...
To learn and practice modern backend development in C# using ASP.NET Core, Entity Framework Core, and PostgreSQL, while applying layered architecture principles.

I wanted to create a real-world project that could serve as a portfolio piece and demonstrate my skills in backend development, API design, and software architecture.
...
Modifying it would have been constrained by earlier design decisions and would not have allowed me to apply best practices from the ground up.
Rebuilding it gave me the opportunity to create a more structured, maintainable, and scalable application while learning new technologies.
